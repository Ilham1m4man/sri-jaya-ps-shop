...
export default function ModalProduct({ modal_product, currentRole, isModalProductOpen }) {
      ...
      <section className="modal absolute top-0 bg-bg-blur-clr backdrop-blur bg-opacity-40 w-full flex justify-center">
        <div className="rounded-[20px] mb-auto bg-white opacity-100 flex flex-col gap-[68px] items-center justify-center w-[98%]">
          <div className="flex justify-end w-full pt-8 px-12">
            ...
            <BackBtn backFrom={modal_product} customClass={"px-[2px]"} />
          </div>
            ...
            <div className="max-w-[620px] text-grn-950 flex flex-col gap-[70px]">
              ...
              <div className="flex flex-col gap-[30px]">
                ...
                <div className="text-[24px] font-normal flex">
                  <p>
                    Kategori/Berat<span className="pr-[20px] pl-[54px]">:</span>
                  </p>
                  <p>Pakan/800gr</p>
                </div>
                <div className="text-[24px] font-normal flex">
        ...
        <Dialog as="div" className="relative z-20" onClose={modal_product}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center py-4 text-center">
              ...
              >
                <Dialog.Panel className="w-[98%] transform overflow-hidden rounded-[20px] bg-gradient-to-b from-mainBg_clr to-white py-[50px] px-12 text-left flex flex-col gap-[60px] items-center shadow-xl transition-all">
                  <div className="flex justify-end w-full relative items-center">
                    ...
                    <BackBtn backFrom={modal_product} customClass={"absolute px-[2px]"} />
                  </div>
                    ...
                    <div className="w-[90%] grid gap-y-[50px]">
                      ...
                      <div className="flex flex-col gap-[30px]">
                        <div className="text-[24px] font-normal flex">
                          <p>
                            Kategori
                            <span className="pr-[20px] pl-[54px]">:</span>
                          </p>
                          <p>Pakan</p>
                        </div>
                        <div className="text-[24px] font-normal flex flex-col items-start">
